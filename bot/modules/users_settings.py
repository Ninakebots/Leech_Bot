...
handler_dict = {}
desp_dict = {'rcc': ['ʀᴄʟᴏɴᴇ ɪs ᴀ ᴄᴏᴍᴍᴀɴᴅ-ʟɪɴᴇ ᴘʀᴏɢʀᴀᴍ ᴛᴏ sʏɴᴄ ғɪʟᴇs ᴀɴᴅ ᴅɪʀᴇᴄᴛᴏʀɪᴇs ᴛᴏ ᴀɴᴅ ғʀᴏᴍ ᴅɪғғᴇʀᴇɴᴛ ᴄʟᴏᴜᴅ sᴛᴏʀᴀɢᴇ ᴘʀᴏᴠɪᴅᴇʀs ʟɪᴋᴇ ɢᴅʀɪᴠᴇ, ᴏɴᴇᴅʀɪᴠᴇ...', 'sᴇɴᴅ ʀᴄʟᴏɴᴇ.ᴄᴏɴғ. \n<b>ᴛɪᴍᴇᴏᴜᴛ:</b> 60 sᴇᴄ'],
            'lprefix': ['ʟᴇᴇᴄʜ ғɪʟᴇɴᴀᴍᴇ ᴘʀᴇғɪx ɪs ᴛʜᴇ ғʀᴏɴᴛ ᴘᴀʀᴛ ᴀᴛᴛᴀᴄᴛᴇᴅ ᴡɪᴛʜ ᴛʜᴇ ғɪʟᴇɴᴀᴍᴇ ᴏғ ᴛʜᴇ ʟᴇᴇᴄʜ ғɪʟᴇs.', 'sᴇɴᴅ ʟᴇᴇᴄʜ ғɪʟᴇɴᴀᴍᴇ ᴘʀᴇғɪx. ᴅᴏᴄᴜᴍᴇɴᴛᴀᴛɪᴏɴ ʜᴇʀᴇ : <a href="https://t.me/KPSBots/87">ᴄʟɪᴄᴋ ᴍᴇ</a> \n<b>ᴛɪᴍᴇᴏᴜᴛ:</b> 60 sᴇᴄ'],
            'lsuffix': ['ʟᴇᴇᴄʜ ғɪʟᴇɴᴀᴍᴇ sᴜғғɪx ɪs ᴛʜᴇ ᴇɴᴅ ᴘᴀʀᴛ ᴀᴛᴛᴀᴄʜᴇᴅ ᴡɪᴛʜ ᴛʜᴇ ғɪʟᴇɴᴀᴍᴇ ᴏғ ᴛʜᴇ ʟᴇᴇᴄʜ ғɪʟᴇs', 'sᴇɴᴅ ʟᴇᴇᴄʜ ғɪʟᴇɴᴀᴍᴇ sᴜғғɪx. ᴅᴏᴄᴜᴍᴇɴᴛᴀᴛɪᴏɴ ʜᴇʀᴇ : <a href="https://t.me/KPSBots/87">ᴄʟɪᴄᴋ ᴍᴇ</a> \n<b>ᴛɪᴍᴇᴏᴜᴛ:</b> 60 sᴇᴄ'],
            'lremname': ['ʟᴇᴇᴄʜ ғɪʟᴇɴᴀᴍᴇ ʀᴇᴍɴᴀᴍᴇ ɪs ᴄᴏᴍʙɪɴᴀᴛɪᴏɴ ᴏғ ʀᴇɢᴇx(s) ᴜsᴇᴅ ғᴏʀ ʀᴇᴍᴏᴠɪɴɢ ᴏʀ ᴍᴀɴɪᴘᴜʟᴀᴛɪɴɢ ғɪʟᴇɴᴀᴍᴇ ᴏғ ᴛʜᴇ ʟᴇᴇᴄʜ ғɪʟᴇs', 'sᴇɴᴅ ʟᴇᴇᴄʜ ғɪʟᴇɴᴀᴍᴇ ʀᴇᴍɴᴀᴍᴇ. ᴅᴏᴄᴜᴍᴇɴᴛᴀᴛɪᴏɴ ʜᴇʀᴇ : <a href="https://t.me/KPSBots/87">ᴄʟɪᴄᴋ ᴍᴇ</a> \n<b>ᴛɪᴍᴇᴏᴜᴛ:</b> 60 sᴇᴄ'],
            'lcaption': ['ʟᴇᴇᴄʜ ᴄᴀᴘᴛɪᴏɴ ɪs ᴛʜᴇ ᴄᴜsᴛᴏᴍ ᴄᴀᴘᴛɪᴏɴ ᴏɴ ᴛʜᴇ ʟᴇᴇᴄʜ ғɪʟᴇs ᴜᴘʟᴏᴀᴅᴇᴅ ʙʏ ᴛʜᴇ ʙᴏᴛ', 'sᴇɴᴅ ʟᴇᴇᴄʜ ᴄᴀᴘᴛɪᴏɴ. ʏᴏᴜ ᴄᴀɴ ᴀᴅᴅ ʜᴛᴍʟ ᴛᴀɢs. ᴅᴏᴄᴜᴍᴇɴᴛᴀᴛɪᴏɴ ʜᴇʀᴇ : <a href="https://t.me/KPSBots/87">ᴄʟɪᴄᴋ ᴍᴇ</a> \n<b>ᴛɪᴍᴇᴏᴜᴛ:</b> 60 sᴇᴄ'],
            'ldump': ['ʟᴇᴇᴄʜ ғɪʟᴇs ᴜsᴇʀ ᴅᴜᴍᴘ ғᴏʀ ᴘᴇʀsᴏɴᴀʟ ᴜsᴇ ᴀs ᴀ sᴛᴏʀᴀɢᴇ.', 'sᴇɴᴅ ʟᴇᴇᴄʜ ᴅᴜᴍᴘ ᴄʜᴀɴɴᴇʟ ɪᴅ\n➲ <b>ғᴏʀᴍᴀᴛ:</b> \nᴛɪᴛʟᴇ ᴄʜᴀᴛ_ɪᴅ/@ᴜsᴇʀɴᴀᴍᴇ\nᴛɪᴛʟᴇ2 ᴄʜᴀᴛ_ɪᴅ2/@ᴜsᴇʀɴᴀᴍᴇ2. \n\n<b>ɴᴏᴛᴇ:</b>ᴍᴀᴋᴇ ʙᴏᴛ ᴀᴅᴍɪɴ ɪɴ ᴛʜᴇ ᴄʜᴀɴɴᴇʟ ᴇʟsᴇ ɪᴛ ᴡɪʟʟ ɴᴏᴛ ᴀᴄᴄᴇᴘᴛ\n<b>ᴛɪᴍᴇᴏᴜᴛ:</b> 60 sᴇᴄ'],
            'metadata': ['ʏᴏᴜʀ ᴄʜᴀɴɴᴇʟ ɴᴀᴍᴇ ᴛʜᴀᴛ sʜᴏᴜʟᴅ ʙᴇ ᴜsᴇᴅ ᴡʜɪʟᴇ ᴇᴅɪᴛɪɴɢ ᴍᴇᴛᴀᴅᴀᴛᴀ ᴏғ ᴛʜᴇ ғɪʟᴇ', 'sᴇɴᴅ ғɪʟᴇ ᴍᴇᴛᴀᴅᴀᴛᴀ\n<b>ᴛɪᴍᴇᴏᴜᴛ:</b> 60 sᴇᴄ'],
            'lattachment': ['ᴀᴛᴛᴀᴄʜᴍᴇɴᴛ ᴜʀʟ, ɪᴛ ᴡɪʟʟ ᴀᴅᴅᴇᴅ ɪɴ ᴍᴋᴠ ᴀs ᴛʜᴜᴍʙɴᴀɪʟ ᴏʀ ᴄᴏᴠᴇʀ ᴘʜᴏᴛᴏ, ᴡʜᴇᴛᴇᴠᴇʀ ʏᴏᴜ sᴀʏ.', 'sᴇɴᴅ ᴛᴇʟᴇɢʀᴀᴘʜ ᴘʜᴏᴛᴏ ᴜʀʟ\n\n<b>ᴛɪᴍᴇᴏᴜᴛ:</b> 60 sᴇᴄ'],
            'mprefix': ['ᴍɪʀʀᴏʀ ғɪʟᴇɴᴀᴍᴇ ᴘʀᴇғɪx ɪs ᴛʜᴇ ғʀᴏɴᴛ ᴘᴀʀᴛ ᴀᴛᴛᴀᴄᴛᴇᴅ ᴡɪᴛʜ ᴛʜᴇ ғɪʟᴇɴᴀᴍᴇ ᴏғ ᴛʜᴇ ᴍɪʀʀᴏʀᴇᴅ/ᴄʟᴏɴᴇᴅ ғɪʟᴇs.', 'sᴇɴᴅ ᴍɪʀʀᴏʀ ғɪʟᴇɴᴀᴍᴇ ᴘʀᴇғɪx. \n<b>ᴛɪᴍᴇᴏᴜᴛ:</b> 60 sᴇᴄ'],
            'msuffix': ['ᴍɪʀʀᴏʀ ғɪʟᴇɴᴀᴍᴇ sᴜғғɪx ɪs ᴛʜᴇ ᴇɴᴅ ᴘᴀʀᴛ ᴀᴛᴛᴀᴄʜᴇᴅ ᴡɪᴛʜ ᴛʜᴇ ғɪʟᴇɴᴀᴍᴇ ᴏғ ᴛʜᴇ ᴍɪʀʀᴏʀᴇᴅ/ᴄʟᴏɴᴇᴅ ғɪʟᴇs', 'sᴇɴᴅ ᴍɪʀʀᴏʀ ғɪʟᴇɴᴀᴍᴇ sᴜғғɪx. \n<b>ᴛɪᴍᴇᴏᴜᴛ:</b> 60 sᴇᴄ'],
            'mremname': ['ᴍɪʀʀᴏʀ ғɪʟᴇɴᴀᴍᴇ ʀᴇᴍɴᴀᴍᴇ ɪs ᴄᴏᴍʙɪɴᴀᴛɪᴏɴ ᴏғ ʀᴇɢᴇx(s) ᴜsᴇᴅ ғᴏʀ ʀᴇᴍᴏᴠɪɴɢ ᴏʀ ᴍᴀɴɪᴘᴜʟᴀᴛɪɴɢ ғɪʟᴇɴᴀᴍᴇ ᴏғ ᴛʜᴇ ᴍɪʀʀᴏʀᴇᴅ/ᴄʟᴏɴᴇᴅ ғɪʟᴇs', 'sᴇɴᴅ ᴍɪʀʀᴏʀ ғɪʟᴇɴᴀᴍᴇ ʀᴇᴍɴᴀᴍᴇ. \n<b>ᴛɪᴍᴇᴏᴜᴛ:</b> 60 sᴇᴄ'],
            'thumb': ['ᴄᴜsᴛᴏᴍ ᴛʜᴜᴍʙɴᴀɪʟ ᴛᴏ ᴀᴘᴘᴇᴀʀ ᴏɴ ᴛʜᴇ ʟᴇᴇᴄʜᴇᴅ ғɪʟᴇs ᴜᴘʟᴏᴀᴅᴇᴅ ʙʏ ᴛʜᴇ ʙᴏᴛ', 'sᴇɴᴅ ᴀ ᴘʜᴏᴛᴏ ᴛᴏ sᴀᴠᴇ ɪᴛ ᴀs ᴄᴜsᴛᴏᴍ ᴛʜᴜᴍʙɴᴀɪʟ. \n<b>ᴀʟᴛᴇʀɴᴀᴛɪᴠᴇʟʏ: </b><code>/ᴄᴍᴅ [ᴘʜᴏᴛᴏ] -s ᴛʜᴜᴍʙ</code> \n<b>ᴛɪᴍᴇᴏᴜᴛ:</b> 60 sᴇᴄ'],
            'yt_opt': ['ʏᴛ-ᴅʟᴘ ᴏᴘᴛɪᴏɴs ɪs ᴛʜᴇ ᴄᴜsᴛᴏᴍ ϙᴜᴀʟɪᴛʏ ғᴏʀ ᴛʜᴇ ᴇxᴛʀᴀᴄᴛɪᴏɴ ᴏғ ᴠɪᴅᴇᴏs ғʀᴏᴍ ᴛʜᴇ ʏᴛ-ᴅʟᴘ sᴜᴘᴘᴏʀᴛᴇᴅ sɪᴛᴇs.', 'sᴇɴᴅ ʏᴛ-ᴅʟᴘ ᴏᴘᴛɪᴏɴs. ᴛɪᴍᴇᴏᴜᴛ: 60 sᴇᴄ\nғᴏʀᴍᴀᴛ: ᴋᴇʏ:ᴠᴀʟᴜᴇ|ᴋᴇʏ:ᴠᴀʟᴜᴇ|ᴋᴇʏ:ᴠᴀʟᴜᴇ.\nᴇxᴀᴍᴘʟᴇ: ғᴏʀᴍᴀᴛ:ʙᴠ*+ᴍᴇʀɢᴇᴀʟʟ[ᴠᴄᴏᴅᴇᴄ=ɴᴏɴᴇ]|ɴᴏᴄʜᴇᴄᴋᴄᴇʀᴛɪғɪᴄᴀᴛᴇ:ᴛʀᴜᴇ\nᴄʜᴇᴄᴋ ᴀʟʟ ʏᴛ-ᴅʟᴘ ᴀᴘɪ ᴏᴘᴛɪᴏɴs ғʀᴏᴍ ᴛʜɪs <a href="https://github.com/yt-dlp/yt-dlp/blob/master/yt_dlp/YoutubeDL.py#L184">ғɪʟᴇ</a> ᴛᴏ ᴄᴏɴᴠᴇʀᴛ ᴄʟɪ ᴀʀɢᴜᴍᴇɴᴛs ᴛᴏ ᴀᴘɪ ᴏᴘᴛɪᴏɴs.'],
            'usess': [f'ᴜsᴇʀ sᴇssɪᴏɴ ɪs ᴛᴇʟᴇɢʀᴀᴍ sᴇssɪᴏɴ ᴜsᴇᴅ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ ᴘʀɪᴠᴀᴛᴇ ᴄᴏɴᴛᴇɴᴛs ғʀᴏᴍ ᴘʀɪᴠᴀᴛᴇ ᴄʜᴀɴɴᴇʟs ᴡɪᴛʜ ɴᴏ ᴄᴏᴍᴘʀᴏᴍɪsᴇ ɪɴ ᴘʀɪᴠᴀᴄʏ, ʙᴜɪʟᴅ ᴡɪᴛʜ ᴇɴᴄʀʏᴘᴛɪᴏɴ.\n{"<b>ᴡᴀʀɴɪɴɢ:</b> ᴛʜɪs ʙᴏᴛ ɪs ɴᴏᴛ sᴇᴄᴜʀᴇᴅ. ᴡᴇ ʀᴇᴄᴏᴍᴍᴇɴᴅ ᴀsᴋɪɴɢ ᴛʜᴇ ɢʀᴏᴜᴘ ᴏᴡɴᴇʀ ᴛᴏ sᴇᴛ ᴛʜᴇ ᴜᴘsᴛʀᴇᴀᴍ ʀᴇᴘᴏ ᴛᴏ ᴛʜᴇ ᴏғғɪᴄɪᴀʟ ʀᴇᴘᴏ. ɪғ ɪᴛ ɪs ɴᴏᴛ ᴛʜᴇ ᴏғғɪᴄɪᴀʟ ʀᴇᴘᴏ, ᴛʜᴇɴ ᴋᴘsᴍʟ-x ɪs ɴᴏᴛ ʀᴇsᴘᴏɴsɪʙʟᴇ ғᴏʀ ᴀɴʏ ɪssᴜᴇs ᴛʜᴀᴛ ᴍᴀʏ ᴏᴄᴄᴜʀ ɪɴ ʏᴏᴜʀ ᴀᴄᴄᴏᴜɴᴛ." if config_dict["UPSTREAM_REPO"] != "https://github.com/Tamilupdates/KPSML-X" else "ʙᴏᴛ ɪs sᴇᴄᴜʀᴇ. ʏᴏᴜ ᴄᴀɴ ᴜsᴇ ᴛʜᴇ sᴇssɪᴏɴ sᴇᴄᴜʀᴇʟʏ."}', 'sᴇɴᴅ ʏᴏᴜʀ sᴇssɪᴏɴ sᴛʀɪɴɢ.\n<b>ᴛɪᴍᴇᴏᴜᴛ:</b> 60 sᴇᴄ'],
            'split_size': ['ʟᴇᴇᴄʜ sᴘʟɪᴛs sɪᴢᴇ ɪs ᴛʜᴇ sɪᴢᴇ ᴛᴏ sᴘʟɪᴛ ᴛʜᴇ ʟᴇᴇᴄʜᴇᴅ ғɪʟᴇ ʙᴇғᴏʀᴇ ᴜᴘʟᴏᴀᴅɪɴɢ', f'sᴇɴᴅ ʟᴇᴇᴄʜ sᴘʟɪᴛ sɪᴢᴇ ɪɴ ᴀɴʏ ᴄᴏᴍғᴏʀᴛᴀʙʟᴇ sɪᴢᴇ, ʟɪᴋᴇ 2ɢʙ, 500ᴍʙ ᴏʀ 1.46ɢʙ. \n<b>ᴘʀᴇᴍɪᴜᴍ ᴀᴄᴛɪᴠᴇ:</b> {IS_PREMIUM_USER}. \n<b>ᴛɪᴍᴇᴏᴜᴛ:</b> 60 sᴇᴄ'],
            'ddl_servers': ['ᴅᴅʟ sᴇʀᴠᴇʀs ᴡʜɪᴄʜ ᴜᴘʟᴏᴀᴅs ʏᴏᴜʀ ғɪʟᴇ ᴛᴏ ᴛʜᴇɪʀ sᴘᴇᴄɪғɪᴄ ʜᴏsᴛɪɴɢ', ''],
            'user_tds': [f'ᴜsᴇʀᴛᴅ ʜᴇʟᴘs ᴛᴏ ᴜᴘʟᴏᴀᴅ ғɪʟᴇs ᴠɪᴀ ʙᴏᴛ ᴛᴏ ʏᴏᴜʀ ᴄᴜsᴛᴏᴍ ᴅʀɪᴠᴇ ᴅᴇsᴛɪɴᴀᴛɪᴏɴ ᴠɪᴀ ɢʟᴏʙᴀʟ sᴀ ᴍᴀɪʟ\n\n➲ <b>sᴀ ᴍᴀɪʟ :</b> {"ɴᴏᴛ sᴘᴇᴄɪғɪᴇᴅ" if "USER_TD_SA" not in config_dict else config_dict["USER_TD_SA"]}', 'sᴇɴᴅ ᴜsᴇʀ ᴛᴅ ᴅᴇᴛᴀɪʟs ғᴏʀ ᴜsᴇ ᴡʜɪʟᴇ ᴍɪʀʀᴏʀ/ᴄʟᴏɴᴇ\n➲ <b>ғᴏʀᴍᴀᴛ:</b>\nɴᴀᴍᴇ ɪᴅ/ʟɪɴᴋ ɪɴᴅᴇx(ᴏᴘᴛɪᴏɴᴀʟ)\nɴᴀᴍᴇ2 ʟɪɴᴋ2/ɪᴅ2 ɪɴᴅᴇx(ᴏᴘᴛɪᴏɴᴀʟ)\n\n<b>ɴᴏᴛᴇ:</b>\n<i>1. ᴅʀɪᴠᴇ ɪᴅ ᴍᴜsᴛ ʙᴇ ᴠᴀʟɪᴅ, ᴛʜᴇɴ ᴏɴʟʏ ɪᴛ ᴡɪʟʟ ᴀᴄᴄᴇᴘᴛ\n2. ɴᴀᴍᴇs ᴄᴀɴ ʜᴀᴠᴇ sᴘᴀᴄᴇs\n3. ᴀʟʟ ᴜsᴇʀᴛᴅs ᴀʀᴇ ᴜᴘᴅᴀᴛᴇᴅ ᴏɴ ᴇᴠᴇʀʏ ᴄʜᴀɴɢᴇ\n4. ᴛᴏ ᴅᴇʟᴇᴛᴇ sᴘᴇᴄɪғɪᴄ ᴜsᴇʀᴛᴅ, ɢɪᴠᴇ ɴᴀᴍᴇ(s) sᴇᴘᴀʀᴀᴛᴇᴅ ʙʏ ᴇᴀᴄʜ ʟɪɴᴇ</i>\n\n<b>ᴛɪᴍᴇᴏᴜᴛ:</b> 60 sᴇᴄ'],
            'gofile': ['ɢᴏғɪʟᴇ ɪs ᴀ ғʀᴇᴇ ғɪʟᴇ sʜᴀʀɪɴɢ ᴀɴᴅ sᴛᴏʀᴀɢᴇ ᴘʟᴀᴛғᴏʀᴍ. ʏᴏᴜ ᴄᴀɴ sᴛᴏʀᴇ ᴀɴᴅ sʜᴀʀᴇ ʏᴏᴜʀ ᴄᴏɴᴛᴇɴᴛ ᴡɪᴛʜᴏᴜᴛ ᴀɴʏ ʟɪᴍɪᴛ.', "sᴇɴᴅ ɢᴏғɪʟᴇ's ᴀᴘɪ ᴋᴇʏ. ɢᴇᴛ ɪᴛ ᴏɴ ʜᴛᴛᴘs://ɢᴏғɪʟᴇ.ɪᴏ/ᴍʏᴘʀᴏғɪʟᴇ, ɪᴛ ᴡɪʟʟ ɴᴏᴛ ʙᴇ ᴀᴄᴄᴇᴘᴛᴇᴅ ɪғ ᴛʜᴇ ᴀᴘɪ ᴋᴇʏ ɪs ɪɴᴠᴀʟɪᴅ !!\n<b>ᴛɪᴍᴇᴏᴜᴛ:</b> 60 sᴇᴄ"],
            'streamtape': ['sᴛʀᴇᴀᴍᴛᴀᴘᴇ ɪs ғʀᴇᴇ ᴠɪᴅᴇᴏ sᴛʀᴇᴀᴍɪɴɢ & sʜᴀʀɪɴɢ ʜᴏsᴛᴇʀ', "sᴇɴᴅ sᴛʀᴇᴀᴍᴛᴀᴘᴇ's ʟᴏɢɪɴ ᴀɴᴅ ᴋᴇʏ\n<b>ғᴏʀᴍᴀᴛ:</b> <code>ᴜsᴇʀ_ʟᴏɢɪɴ:ᴘᴀss_ᴋᴇʏ</code>\n<b>ᴛɪᴍᴇᴏᴜᴛ:</b> 60 sᴇᴄ"],
            }
